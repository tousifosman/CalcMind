...
// `dirtyClosure` to seed ∪ transitive dependents in topological order.
// Callers keep calling `recomputeFromSeeds` with the same signature — the
// cascade lands without rewriting the store wiring.
