...
| [2026-08-04](2026-08-04.md) | P2.8–P2 exit; P3.1–P3.7 snapping; P4.1–P4.7 engine + result lifecycle; P4.9 continuation (§8.7); done-task strikethrough convention added then reverted to colour/checkbox-only |