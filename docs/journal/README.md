...
| [2026-08-15](2026-08-15.md) | Cell numeral font size reduced 30→22 and weight 800→400 (`tokens.numeralFontSize`/`numeralFontWeight`), a deliberate departure from the §1.2 reference-sampled values |
