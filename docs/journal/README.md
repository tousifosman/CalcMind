...
| [2026-08-14](2026-08-14.md) | Keypad's two six-row columns now align row-for-row — unified every key to `digitKey`'s 48px height, a latent 44-vs-48 gap only exposed once `()`'s move made the row counts match |
