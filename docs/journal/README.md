...
| [2026-08-15](2026-08-15.md) | Cell numeral font size reduced 30→22 and weight 800→400, a deliberate departure from the §1.2 reference-sampled values; follow-up found `numeralFontSize` alone doesn't reflow number-cell width (the glyph-width table is a hand-derived cache, not a live scale) and fixed it alongside a `numberPaddingX` 12→8 reduction |
