...
| [2026-08-04](2026-08-04.md) | P2.8 input dispatch; two real-browser-only bugs in gesture-handler/keypad focus handling; P2 phase close-out; P3.1–P3.5 snapping; P3.7 chain move vs detach (§17.1 closed) |
