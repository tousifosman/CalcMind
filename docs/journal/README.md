...
| [2026-08-04](2026-08-04.md) | P2.8 input dispatch; two real-browser-only bugs in gesture-handler/keypad focus handling; P2 phase close-out; P3.1 chain layout pass |
