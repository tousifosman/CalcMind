...
| [2026-08-04](2026-08-04.md) | P2.8–P2 exit; P3.1–P3.7 snapping; P4.1–P4.9 engine + continuation; P4 phase exit; P5.3 native storage adapter; P5.4 web adapter + P5.8 export/import; P6.2 incremental cascade |