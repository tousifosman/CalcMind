...
| [2026-08-08](2026-08-08.md) | Soft-keyboard suppress; Clear-confirm hides keypad; merge paren keys; add Heroicons; focus chrome: stacking, group clear, `=`→result, no identity ring while selected |
