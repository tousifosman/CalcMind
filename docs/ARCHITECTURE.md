...
- Connectors are drawn for **all** links by default, not only the selected one. Tydlig hides them
  ...
  rather than leaving prior curves vivid (decision #24). Dangling refs draw no curve (§11.2 owns
  their chrome).
