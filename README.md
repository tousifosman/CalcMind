...
**[docs/DEVELOPMENT_PLAN.md](docs/DEVELOPMENT_PLAN.md)** is the build order: what is done, and the
remaining phases broken into tasks with their own objectives, architecture references and
acceptance criteria.
